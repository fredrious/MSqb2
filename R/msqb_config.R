#' Configure MSqb2 Analysis Parameters
#'
...
#'
#' @param build.para A list or object containing the build parameters for the MSqb2 analysis pipeline. This list is generated by the function `MSqb_build()`.
#' @param config.file A character string specifying the path to a configuration file to load. If `NULL`, no configuration file is loaded. Default is `NULL`.
#' @param interactive Logical. If `TRUE`, the function may prompt the user for input during execution. Default is `TRUE`.
...
#' @param medianpolish.method A character string specifying the method for median polishing. Options include `"column.eff"` and `"residual"`. Default is `"column.eff"`.
#' @param medianpolish.byPool Logical. If `TRUE`, median polishing is performed by pool (in TMT method). Default is `FALSE`.
...
#' @param manual.contrasts A list specifying manual contrasts to be applied. Default is `NULL`.
#' @param choose.contrasts Logical. If `TRUE`, allows the user to choose contrasts interactively. Default is `FALSE`.
#' @param pairwise.denominator A character string or `NULL` specifying the denominator for pairwise contrasts. Default is `NULL`.
#' @param protein.column A character string specifying the column name for proteins in the input data. Default is `"Master Protein Accessions"`.
#' @param peptide.seq.column A character string specifying the column name for peptide sequences in the input data. Default is `"Sequence"`.
#' @param peptide.annot.seq.column A character string specifying the column name for annotated peptide sequences. Default is `"Annotated Sequence"`.
#' @param charge.column A character string specifying the column name for charge in the input data. Default is `"Charge"`.
#' @param FileID.column A character string specifying the column name for file IDs in the input data. Default is `"File ID"`.
#' @param quaninfo.column A character string specifying the column name for quantification information. Default is `"Quan Info"`.
#' @param isolation.interference.column A character string specifying the column name for isolation interference. Default is `"Isolation Interference [%]"`.
#' @param ion.score.column A character string specifying the column name for ion scores. Default is `"Ions Score"`.
#' @param filename.column A character string specifying the column name for filenames in the input data. Default is `"Spectrum File"`.
#' @param abundance.columns A character string specifying the column name for abundance values. Default is `"Abundance"`.
#' @param desc.column A character string specifying the column name for protein descriptions. Default is `"Master Protein Descriptions"`.
#' @param contaminant.column A character string specifying the column name for contaminants. Default is `"Contaminant"`.
#' @param marked.as.column A character string specifying the column name for marked entries in the input data. Default is `"Marked as"`.
#' @param subsymDT A `data.table` defining symbolic substitutions, with columns `symout` and `symin` for output and input symbols respectively.
