...
#'
#' @details The `median_normalisation` function applies median normalization to the data, which adjusts the values in each sample such that
...
#'
#' @export
median_normalisation <- function(dat,
                    col.p,
                    row.p,
                    val,
                    log2transform = TRUE,
